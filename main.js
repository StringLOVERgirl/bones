     ...
     play_elements.forEach(e=>
      ...
      function audioplayer(type,code,tracknumber){
        ...
        if (tracks[tracknumber].paused) {
          pshide()
          video.pause()
          playstatus.style.setProperty('--ps', 'url(./assets//noun-play-6054301.svg) center / contain no-repeat')
          ...
          playstatus.style.setProperty('--ps', 'url(./assets/noun-pause-2731843.svg) center / contain no-repeat')
